...
function Vue(options) {
  if (NODE_ENV !== "production" && !(this instanceof Vue)) {
...
Vue.prototype._init = function (options?: Object) {
  ...
  let startTag, endTag;
  /* istanbul ignore if */
  if (NODE_ENV !== "production" && config.performance && mark) {
...
Vue.prototype._render = function (): VNode {
  ...
  try {
    ...
    /* istanbul ignore else */
    if (NODE_ENV !== "production" && vm.$options.renderError) {
      try {
  ...
  if (!(vnode instanceof VNode)) {
    if (NODE_ENV !== "production" && Array.isArray(vnode)) {
      warn(
